...
//              // mNotification.setLatestEventInfo(this, "Crowdpp4.0", "The Service is Running", pendingIntent);
...
//			else {
//				try {
//					speaker_count = SpeakerCount.unsupervised(tst_files)[0];
//					percentage = -1;					
//				} catch (IOException e) {
//					e.printStackTrace();
//				}
...
////	public class S3PutDataBaseTask extends AsyncTask<String, String, Integer> {
////
