...
public class Constants {
	...
	public static String ACCESS_KEY_ID = "vxr0cq49WM0cpNGaG9QX";
	public static String SECRET_KEY = "b4265f86d08ce967696006b69f69bc7dbec05f3f";
	
//	public static String dbBucket = (ACCESS_KEY_ID + ".crowdppDatabase").toLowerCase(Locale.CHINA);
	public static String dbBucket ="Speech-Phone";
	public static String calBucket = (ACCESS_KEY_ID + ".crowdppCalibration").toLowerCase(Locale.CHINA);
	...
	public static boolean test_feature_keep = false;
  ...
  public static boolean calibration() {
	...
	public static String cal_text		= "The most direct form of social interaction occurs through the spoken language and conversations.	" 
																	...
																	+ "recorded during peoples conversations	to distill the various attributes that characterize this " 
